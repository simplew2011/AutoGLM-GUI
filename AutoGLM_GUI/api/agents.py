...
def get_config_endpoint() -> ConfigResponse:
    ...
    return ConfigResponse(
        ...
        decision_max_tokens=effective_config.decision_max_tokens,
        decision_temperature=effective_config.decision_temperature,
        decision_top_p=effective_config.decision_top_p,
        decision_frequency_penalty=effective_config.decision_frequency_penalty,
        decision_extra_body=effective_config.decision_extra_body,
        ...
        chat_max_tokens=effective_config.chat_max_tokens,
        chat_temperature=effective_config.chat_temperature,
        chat_top_p=effective_config.chat_top_p,
        chat_frequency_penalty=effective_config.chat_frequency_penalty,
        chat_extra_body=effective_config.chat_extra_body,
        ...
        intent_max_tokens=effective_config.intent_max_tokens,
        intent_temperature=effective_config.intent_temperature,
        intent_top_p=effective_config.intent_top_p,
        intent_frequency_penalty=effective_config.intent_frequency_penalty,
        intent_extra_body=effective_config.intent_extra_body,
        conflicts=[
            {
                "field": c.field,
...
def save_config_endpoint(request: ConfigSaveRequest) -> dict[str, Any]:
    ...
    try:
        ...
        success = config_manager.save_file_config(
            ...
            decision_max_tokens=request.decision_max_tokens,
            decision_temperature=request.decision_temperature,
            decision_top_p=request.decision_top_p,
            decision_frequency_penalty=request.decision_frequency_penalty,
            decision_extra_body=request.decision_extra_body,
            ...
            chat_max_tokens=request.chat_max_tokens,
            chat_temperature=request.chat_temperature,
            chat_top_p=request.chat_top_p,
            chat_frequency_penalty=request.chat_frequency_penalty,
            chat_extra_body=request.chat_extra_body,
            intent_base_url=request.intent_base_url,
            intent_model_name=request.intent_model_name,
            intent_api_key=request.intent_api_key,
            intent_max_tokens=request.intent_max_tokens,
            intent_temperature=request.intent_temperature,
            intent_top_p=request.intent_top_p,
            intent_frequency_penalty=request.intent_frequency_penalty,
            intent_extra_body=request.intent_extra_body,
            merge_mode=True,
